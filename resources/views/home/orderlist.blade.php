...
<body>
	...
	<!-- ================== BEGIN BASE JS ================== -->
	<script src="/assets/assets/plugins/jquery/jquery-1.9.1.min.js"></script>
	...
	<!--[if lt IE 9]>
		<script src="/assets/assets/crossbrowserjs/html5shiv.js"></script>
		<script src="/assets/assets/crossbrowserjs/respond.min.js"></script>
		<script src="/assets/assets/crossbrowserjs/excanvas.min.js"></script>
	<![endif]-->
	...
	<script src="/assets/assets/plugins/DataTables/media/js/dataTables.bootstrap.min.js"></script>
	<script src="/assets/assets/plugins/DataTables/extensions/KeyTable/js/dataTables.keyTable.min.js"></script>
	<script src="/assets/assets/plugins/DataTables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
	<script src="/assets/assets/js/table-manage-keytable.demo.min.js"></script>
	<script src="/assets/assets/js/apps.min.js"></script>
	<script src="/assets/assets/js/bootbox.min.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== -->
	<script>
	//for folder creation
	...
	$('#yloader').show();
			...
			btdialog = bootbox.dialog({
				...
				size:'medium',
				message: '<div id="yloader" class="loading" style="margin:20px 0px;" align="center"> - loading <img src="//assets/assets/img/yahoo.gif" align="absmiddle"/></div>'
			 });
