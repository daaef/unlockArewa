                    ...
                    <div class="product-detail">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-info-header">
                                <h1 class="product-title"><span class="label label-success">41% OFF</span> {{$item->name}} </h1>
                            ...
                            <div class="product-warranty">
                                <div class="pull-right">Quantity in Store: {{$item->qty}}</div>
                                <div><b>Post by:</b> Sagware International LTD</div>
								<div><b>Contact:</b> +2348109969918</div>
                            </div>
                            ...
                            <div class="product-purchase-container">
								...
								<form action="/add/c" method="post">
								<div class="cart-qty-input">
								
                                                    <a href="#" class="qty-control left disabled" data-click="decrease-qty" data-target="#qty"><i class="fa fa-minus"></i></a><input type="hidden" name="_token" value="{{ csrf_token() }}">
													<input type="hidden" name="item_id" value="{{$item->id}}">
                                                    <input type="text" name="qty" value="1" placeholder="1" class="form-control" id="qty" />
                                                    <a href="#" class="qty-control right disabled" data-click="increase-qty" data-target="#qty"><i class="fa fa-plus"></i></a>
													
													
                                                </div><br/>
                                <button  class="btn btn-inverse btn-lg" type="submit" >ADD TO CART</button></form><br/>
								<button  onClick="orderNow()" class="btn btn-inverse btn-lg" type="submit">ORDER NOW</button>
                            </div>
                            ...
                            <div class="tab-pane fade active in" id="product-desc">
                                ...
                                <div class="product-desc right">
                                    ...
                                    <div class="desc">
                                        ...
                                        <p>
                                           Ground Floor, Nigeria Reinsurrance Building, Herbert Macaulay Way, CBD, Abuja.
                                        </p>
                                    </div>
                                </div>
                                <!-- END product-desc -->
