				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu media-list pull-right animated fadeInDown">
                            ...
                            <li class="media">
                                <a href="javascript:;">
                                    <div class="media-left"><img src="/assets2/img/user-1.jpg" class="media-object" alt="" /></div>
                                    <div class="media-body">
                            ...
                            <li class="media">
                                <a href="javascript:;">
                                    <div class="media-left"><img src="/assets2/img/user-2.jpg" class="media-object" alt="" /></div>
                                    <div class="media-body">
					...
					<li class="dropdown navbar-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							<img src="/assets2/img/user-13.jpg" alt="" /> 
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					<li class="nav-profile">
						<div class="image">
							<a href="javascript:;"><img src="/assets2/img/user-13.jpg" alt="" /></a>
						</div>
						<div class="info">
							Sean Ngu
				...
				<ul class="nav">
					...
					<li>
						<a href="bootstrap_4.html">
							<div class="icon-img">
						    	<img src="/assets2/img/bs4-logo.png" alt="" />
						    </div>
					...
					<li class="has-sub">
					    ...
					    <ul class="sub-menu">
					        ...
					        <li><a href="../template_content_angularjs4/index.html">ANGULAR JS 4 <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
					        <li><a href="../template_content_material/index.html">MATERIAL DESIGN</a></li>
					        <li><a href="../template_content_apple/index.html">APPLE DESIGN <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
					    </ul>
					</li>
					<li class="has-sub">
					    <a href="javascript:;">
                    ...
                    <div class="wrapper">
                        ...
                        <ul class="media-list underline m-b-20 p-b-15">
                            <li class="media media-sm clearfix">
                                <a href="javascript:;" class="pull-left">
                                    <img class="media-object rounded-corner" alt="" src="/assets2/img/user-14.jpg" />
                                </a>
                                <div class="media-body">
                        ...
                        <ul class="attached-document clearfix">
                            ...
                            <li>
                                ...
                                <div class="document-file">
                                    <a href="#">
                                        <img src="/assets2/img/login-bg/bg-1.jpg" alt="" />
                                    </a>
                                </div>
                            </li>
                        </ul>
