...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Manage Your Businesses</small></h1>
			<!-- end page-header -->
			...
			<div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
						...
						<div class="fa-hover col-md-3 col-sm-4 col-xs-12"><a href="/item/del/{{$s->id}}" title="Update Business Location"><i class="fa fa-times"></i> </a>
                        </div>
