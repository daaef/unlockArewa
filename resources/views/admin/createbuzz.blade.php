	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" method="post" action="/new/buzz" enctype="multipart/form-data" data-parsley-validate="true" name="demo-form">
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="fullname">Business/Company/Shop Name * :</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="fullname" name="name" placeholder="e.g Sagware International" data-parsley-required="true" />
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="website" name="website" placeholder="Optional" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" name="phonenumber" id="data-phone"  placeholder="including international code" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="message">Shop Front View Image :</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="file" name="image" id="data-phone" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="message">Business Location :</label>
									<div class="col-md-6 col-sm-6">
										<input type="checkbox" required /> My current locationis is my business location <a href="/map/me">Choose different location</a>
									</div>
								</div>
								<div class="form-group">
